...
# Admin User
MONGODB_ADMIN_USER=${MONGODB_ADMIN_USER:-"$ENV_ADMIN_USER"}
MONGODB_ADMIN_PASS=${MONGODB_ADMIN_PASS:-"$ENV_ADMIN_PASSWORD"}

# Application Database User
MONGODB_APPLICATION_DATABASE=${MONGODB_APPLICATION_DATABASE:-"fulltime"}
MONGODB_APPLICATION_USER=${MONGODB_APPLICATION_USER:-"fulltimeuser"}
MONGODB_APPLICATION_PASS=${MONGODB_APPLICATION_PASS:-"123"}
